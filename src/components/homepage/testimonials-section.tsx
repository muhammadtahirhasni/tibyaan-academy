...
const reviews = [
  { id: 1, name: "Aaliya Mahmood", image: "/Reviewer/Aaliya Mahmood.jpg", country: "Pakistan", flag: "🇵🇰", course: "Nazra Quran", rating: 5, review: "I started Nazra Quran with Tibyaan. The AI Ustaz is available 24/7 — ask anything, get an instant answer. In just 4 months, I can now read the Quran fluently. Alhamdulillah!", role: "Student" },
  { id: 2, name: "Aamir Nazir", image: "/Reviewer/Aamir Nazir.jpg", country: "Pakistan", flag: "🇵🇰", course: "Hifz Quran", rating: 5, review: "The Hifz Tracker has changed my life. The AI-scheduled sabaq, sabqi, and manzil is so organized I never forget my lessons. Combined with a human teacher, this app is truly amazing.", role: "Student" },
  { id: 3, name: "Abdullah Asad", image: "/Reviewer/Abdullah Asad.jpg", country: "United Kingdom", flag: "🇬🇧", course: "Nazra Quran", rating: 5, review: "Finding a good Qari in the UK was difficult. Tibyaan solved that problem. The live class feels just like face-to-face. My child is very happy!", role: "Parent" },
  ...
  { id: 5, name: "Ahmet Kurt", image: "/Reviewer/Ahmet kurt.jpg", country: "Germany", flag: "🇩🇪", course: "Arabic Language", rating: 5, review: "Living in Germany, I wanted to learn Arabic. The sarf and nahw classes are so clear that what seemed difficult became easy. Support in multiple languages is truly outstanding.", role: "Student" },
  { id: 6, name: "Al Hoque", image: "/Reviewer/Al Hoque.jpg", country: "Bangladesh", flag: "🇧🇩", course: "Hifz Quran", rating: 5, review: "I'm from Bangladesh. Tibyaan's Hifz Tracker has been a game changer for me. Daily AI reminders and seeing my progress chart boosts my motivation. Masha'Allah!", role: "Student" },
  { id: 7, name: "Aliyan Ali", image: "/Reviewer/Aliyan Ali.jpg", country: "Indonesia", flag: "🇮🇩", course: "Nazra Quran", rating: 5, review: "I'm from Indonesia. Having support in the Indonesian language is a huge convenience. You can ask the AI Ustaz questions in your own language. Tibyaan is truly a world-class academy!", role: "Student" },
  { id: 8, name: "Amet Kurt Albani", image: "/Reviewer/Amet kurt Albani.jpg", country: "Turkey", flag: "🇹🇷", course: "Aalim Course", rating: 5, review: "Joined the Aalim Course from Turkey. Finding the complete Dars-e-Nizami curriculum online is amazing. The scholarly level of teachers and course with ijazah — only possible at Tibyaan!", role: "Student" },
  ...
  { id: 10, name: "Daruth Tahjeeb", image: "/Reviewer/Daruth Tahjeeb.jpg", country: "Bangladesh", flag: "🇧🇩", course: "Hifz Quran", rating: 5, review: "My daughter is doing hifz and eagerly waits for Tibyaan classes. The interactive kids' games make learning letters feel like play now!", role: "Parent" },
  ...
  { id: 12, name: "Halid Elosman", image: "/Reviewer/Halid Elosman.jpg", country: "Saudi Arabia", flag: "🇸🇦", course: "Aalim Course", rating: 5, review: "I'm from Saudi Arabia and joined the Aalim Course. Seeing the teachers' credentials and scholarly background gave me peace of mind. Despite being online, the environment feels just like a madrasa.", role: "Student" },
  { id: 13, name: "Imran Ejaz", image: "/Reviewer/Imran Ejaz.jpg", country: "Pakistan", flag: "🇵🇰", course: "Hifz Quran", rating: 5, review: "My son memorized 10 paras in 8 months! The Hifz Tracker and teacher's combined effort made it possible. The weekly tests show clear progress.", role: "Parent" },
  { id: 14, name: "Irfan Shahzad", image: "/Reviewer/Irfan Shahzad.jpg", country: "Pakistan", flag: "🇵🇰", course: "Hifz Quran", rating: 5, review: "Tibyaan's AI Ustaz is amazing. Ask a question at 2am — instant reply! Combined with a human teacher, this combination is unbelievable.", role: "Student" },
  { id: 15, name: "Jalal Ahmed", image: "/Reviewer/Jalal Ahmed.jpg", country: "UAE", flag: "🇦🇪", course: "Nazra Quran", rating: 5, review: "I'm from the UAE. Flexible timings were essential in my busy life. Tibyaan's option to set your own schedule made everything easy. My child's pronunciation has improved tremendously!", role: "Parent" },
  ...
  { id: 19, name: "Kaniz Fatima", image: "/Reviewer/Kaniz Fatima.jpg", country: "United Kingdom", flag: "🇬🇧", course: "Nazra Quran", rating: 5, review: "I'm a busy mum in the UK. Tibyaan connected my daughter to the Quran — she now sits and reads on her own every day. She loves doing repetition with the AI Ustaz!", role: "Parent" },
  { id: 20, name: "Kanwal Shaheen", image: "/Reviewer/Kanwal Shaheen.jpg", country: "Australia", flag: "🇦🇺", course: "Arabic Language", rating: 5, review: "Took the Arabic language course from Australia. I had no Arabic before, now I'm starting to understand Quranic translation. Tibyaan truly brought the Quran closer. Thank you Tibyaan!", role: "Student" },
  ...
  { id: 22, name: "M. Zass", image: "/Reviewer/M Zass.jpg", country: "Nigeria", flag: "🇳🇬", course: "Hifz Quran", rating: 5, review: "Started the Hifz journey with my daughter from Nigeria. Tibyaan's environment is just like a madrasa. My daughter is happy, I am happy — Alhamdulillah, this academy proved to be the best choice!", role: "Parent" },
  { id: 23, name: "Mikhail Nilov", image: "/Reviewer/Mikhail Nilov.jpg", country: "Russia", flag: "🇷🇺", course: "Nazra Quran", rating: 5, review: "I'm from Russia and after accepting Islam, I wanted to learn the Quran. Tibyaan gave complete support in English. The teacher's patience and AI assistance — both made learning easy.", role: "Student" },
  { id: 24, name: "Mohameden Beinbe", image: "/Reviewer/Mohameden Beinbe.jpg", country: "Mauritania", flag: "🇲🇷", course: "Hifz Quran", rating: 5, review: "I'm from Mauritania. Tibyaan's Hifz Tracker is very useful for me — there's a complete system for sabaq, sabqi, and manzil. Teachers are very experienced and give special attention to tajweed.", role: "Student" },
  { id: 25, name: "Mohammad Asbad", image: "/Reviewer/Mohammad Asbad.jpg", country: "Pakistan", flag: "🇵🇰", course: "Hifz Quran", rating: 5, review: "I'm from Pakistan. Started Hifz with Tibyaan and completed 7 paras in 5 months. Daily AI reminders and human teacher's guidance — both together work wonders!", role: "Student" },
  ...
  { id: 27, name: "Mujeeb Zain", image: "/Reviewer/Mujeeb Zain.jpg", country: "Bangladesh", flag: "🇧🇩", course: "Nazra Quran", rating: 5, review: "I got my young son started on Nazra at Tibyaan. He loved learning letters through the interactive kids' games. Now he asks for class on his own — Masha'Allah!", role: "Parent" },
  { id: 28, name: "Murtaza Wahhab", image: "/Reviewer/Murtaza Wahhab.jpg", country: "Pakistan", flag: "🇵🇰", course: "Hifz Quran", rating: 5, review: "Seeing the weekly tests and AI progress chart keeps me motivated. The way the human teacher and AI work together at Tibyaan — this is truly a madrasa for the modern age!", role: "Student" },
  ...
  { id: 30, name: "Qamar Rehman", image: "/Reviewer/Qamar Rehman.jpg", country: "Pakistan", flag: "🇵🇰", course: "Hifz Quran", rating: 5, review: "My heart was overjoyed seeing my son's connection with the Quran. The way Tibyaan's teacher taught with such love — it is unforgettable. Started with the 5-day free trial then subscribed immediately.", role: "Parent" },
  { id: 31, name: "Quang Nguyen Vinh", image: "/Reviewer/Quang Nguyen Vinh.jpg", country: "Vietnam", flag: "🇻🇳", course: "Nazra Quran", rating: 5, review: "I'm from Vietnam. Support in English made it possible to learn the Quran. Practice with the AI Ustaz whenever you want — no time restriction. Tibyaan is truly for Muslims all over the world!", role: "Student" },
  { id: 32, name: "Riki Risnandar", image: "/Reviewer/Riki Risnandar.jpg", country: "Indonesia", flag: "🇮🇩", course: "Hifz Quran", rating: 5, review: "I'm doing the Hifz course from Indonesia. Tibyaan's Hifz Tracker creates a daily schedule — lessons stay memorized, progress is visible. Teacher and AI together — it gives peace of mind!", role: "Student" },
  { id: 33, name: "Sabrian Syah", image: "/Reviewer/Sabrian Syah.jpg", country: "Indonesia", flag: "🇮🇩", course: "Arabic Language", rating: 5, review: "I'm learning Arabic from Indonesia. Sarf and nahw classes are taught in a very easy manner. Talk in Arabic with the AI Ustaz whenever you want — all fear and shyness is gone!", role: "Student" },
  { id: 34, name: "Seyh Muskino", image: "/Reviewer/Seyh muskino.jpg", country: "Egypt", flag: "🇪🇬", course: "Aalim Course", rating: 5, review: "Joined the Aalim Course from Egypt. Tibyaan's teachers have a very high scholarly standard. Completing the course with ijazah was the dream of my life — Tibyaan fulfilled it!", role: "Student" },
  { id: 35, name: "Shaheer Nawaz", image: "/Reviewer/Shaheer Nawaz.jpg", country: "United Kingdom", flag: "🇬🇧", course: "Hifz Quran", rating: 5, review: "Living in the UK, I was worried about my son's religious education. Tibyaan removed that worry. Live classes, AI tracker, and weekly tests — all together are giving the best results!", role: "Parent" },
  { id: 36, name: "Shahzaib Jahan", image: "/Reviewer/Shahzaib Jahan.jpg", country: "Canada", flag: "🇨🇦", course: "Nazra Quran", rating: 5, review: "Islamic education in Canada was a challenge. Tibyaan made it possible to learn the Quran from home. My son now recites with great confidence — Masha'Allah!", role: "Parent" },
  { id: 37, name: "Shaista Touseef", image: "/Reviewer/Shaista Touseef.jpg", country: "Pakistan", flag: "🇵🇰", course: "Hifz Quran", rating: 5, review: "I'm from Pakistan. Tibyaan has brought me very close to the Quran. Tajweed practice with the AI Ustaz and lessons with the human teacher — both together make Hifz so much easier!", role: "Student" },
  { id: 38, name: "Sheikh Toulouse", image: "/Reviewer/Sheikh Toulouse.jpg", country: "France", flag: "🇫🇷", course: "Arabic Language", rating: 5, review: "I'm from France. Getting support in French proved to be the greatest blessing for me. After the Arabic language course, I started understanding Quranic translation — heartfelt thanks to Tibyaan!", role: "Student" },
  { id: 39, name: "Sheikh Yousuf", image: "/Reviewer/Sheikh Yousuf.jpg", country: "Saudi Arabia", flag: "🇸🇦", course: "Nazra Quran", rating: 5, review: "Enrolled my sons in Tibyaan from Saudi Arabia. The tajweed standard is very high. Tibyaan's teachers teach with love and sincerity — may Allah reward them greatly!", role: "Parent" },
  { id: 40, name: "Sheza Shehzad", image: "/Reviewer/Sheza Shehzad.jpg", country: "Indonesia", flag: "🇮🇩", course: "Arabic Language", rating: 5, review: "I'm from Indonesia. When I started learning Arabic with Tibyaan, it felt like a new world opened up. Reading the Quran with understanding is now possible — this is Tibyaan's greatest gift!", role: "Student" },
