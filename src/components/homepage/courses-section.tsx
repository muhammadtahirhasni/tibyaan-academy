...
const courses = [
  {
    key: "nazra",
    icon: BookOpen,
    price: formatFee(COURSE_FEES.nazra.plan2Monthly),
  ...
  },
  {
    key: "hifz",
    icon: Sparkles,
    price: formatFee(COURSE_FEES.hifz.plan2Monthly),
  ...
  },
  {
    key: "arabic",
    icon: Languages,
    price: formatFee(COURSE_FEES.arabic.plan2Monthly),
  ...
  },
  {
    key: "aalim",
    icon: GraduationCap,
    price: formatFee(COURSE_FEES.aalim.plan2Monthly),
