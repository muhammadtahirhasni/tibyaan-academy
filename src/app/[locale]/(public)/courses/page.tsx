...
const coursesMeta: Record<string, { title: string; description: string }> = {
  ur: {
    ...
    description:
      "تبیان اکیڈمی کے تمام کورسز دیکھیں — ناظرہ قرآن، حفظ، عربی زبان اور دارس نظامی۔ $33 ماہانہ سے شروع۔",
  },
  ar: {
    title: "الدورات — القرآن والحفظ والعربية ودورة العالم",
    description:
      "تصفح جميع دورات أكاديمية تبيان — الناظرة والحفظ والعربية والعالم. تبدأ من 33 دولار شهرياً.",
  },
  en: {
    title: "Courses — Quran, Hifz, Arabic & Aalim Course",
    description:
      "Browse all Tibyaan Academy courses — Nazra Quran, Hifz, Arabic Language & Dars-e-Nizami. Plans from $33/month.",
  },
  fr: {
    title: "Cours — Coran, Hifz, Arabe et Cours Aalim",
    description:
      "Découvrez tous les cours de Tibyaan Academy — Nazra Coran, Hifz, Langue Arabe & Dars-e-Nizami. À partir de 33$/mois.",
  },
  id: {
    title: "Kursus — Quran, Hifz, Bahasa Arab & Kursus Aalim",
    description:
      "Jelajahi semua kursus Tibyaan Academy — Nazra Quran, Hifz, Bahasa Arab & Dars-e-Nizami. Mulai dari $33/bulan.",
  },
};
